...
describe('mongoose-aplus', function() {
  ...
  var modelData = {indexedRequiredField: 'x', requiredField: 'y'};
  ...
  describe('.Model', function() {
    ...
    it('.createP() Should create and add a document', function(done) {
      SampleModel.createP(modelData)
    ...
    it('.removeP() Should remove a document', function(done) {
      ...
      SampleModel.createP(modelData)
        .then(function() {
          return SampleModel.removeP();
        })
        .then(function() {
          return SampleModel.findP();
        })
  ...
  describe('.Query', function() {
    ...
    it('.findOneP() Should findOne document', function(done) {
      ...
      SampleModel.findOneP(searchQuery)
        .then(function(result) {
          expect(result).to.have.property('_id');
